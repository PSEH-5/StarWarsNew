...
public class JettyRestUtil implements RestUtil {
    ...
    public <Req, Res> Res getAsync(Req req, Map<String, String> requestParams, String url, Response.CompleteListener responseListner) {
